...
## 참여 프로젝트
### 1) [통합 로그인 페이지 제작](#cameriFi-login)
 * #### CameraFi Studio, CameraFi ShopiFi, CameraFi Live에서 각각 따로 운영되고 있던 로그인 페이지들을 하나의 통합 로그인 페이지로 변경
 * #### 애플, 구글, 페이스북, 이메일 등 다양한 로그인 방법 제공
 * #### 회원가입 기능 구현
> 실제 서비스 페이지 : https://login.camerafi.com/?callbackUrl=https%3A%2F%2Fstudio.camerafi.com%2Fko%2Fdashboard

### 2) [스튜디오 스코어보드 페이지 제작](#cameriFi-scoreboard)
* #### 스포츠 중계를 위한 다양한 스포츠 종목의 스코어보드를 제공하고 그에 따른 점수 컨트롤러, 선수 명단 기능을 제공
* #### 스포츠 경기 등록 및 각 경기의 점수, 선수 명단, 경기명, 종목 등의 수정이 가능하고 각 경기의 영상이나 비디오 등록 기능 제공
* #### 경기들을 좋아요 누를 수도 있고 경기를 등록한 사용자 팔로우 기능 제공
